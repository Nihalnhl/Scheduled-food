...
public class Custom_schedulestatus extends BaseAdapter {
...
//    ArrayList<String> f;
    ...
    public Custom_schedulestatus(Context applicationContext, ArrayList<String> a, ArrayList<String> c, ArrayList<String> d, ArrayList<String> e) {
...
//        this.f=f;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_schedulestatus, null);
